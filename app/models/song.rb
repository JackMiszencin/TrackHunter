class Song < ActiveRecord::Base
	...
	has_many :current_merchants, :foreign_key => "previous_song_id", :class_name => "Merchant"
	has_many :previous_merchants, :foreign_key => "current_song_id", :class_name => "Merchant"
